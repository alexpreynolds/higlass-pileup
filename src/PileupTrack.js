...
`,
    ...
    /**
     * A message can be sent from the browser tab that contains the pileup track viewer
     * to the worker responsible for drawing or updating. This function handles those messages.
     */
